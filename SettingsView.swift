...
struct SettingsView: View {
    ...
    private static let credits: [Credit] = [
        ...
        Credit(name: "IJG JPEG", detail: "JPEG codecs (via DCMTK) — Independent JPEG Group",
               license: "IJG License", url: "https://ijg.org"),
        Credit(name: "CharLS", detail: "JPEG-LS codec (via DCMTK) — Jan de Vaan",
               license: "BSD 3-Clause", url: "https://github.com/team-charls/charls"),
        Credit(name: "log4cplus", detail: "Logging (DCMTK oflog) — log4cplus contributors",
               license: "Apache-style", url: "https://github.com/log4cplus/log4cplus"),
    ...
    private var acknowledgements: some View {
        Form {
            Section {
                ...
                Text("DicomFlow is MIT-licensed open source. Full third-party license texts ship in THIRD-PARTY-NOTICES.md and THIRD-PARTY-LICENSES/ alongside the source.\n\nThis software is based in part on the work of the Independent JPEG Group.\n\nDICOM® is the registered trademark of the National Electrical Manufacturers Association (NEMA) for its Standards publications relating to digital communications of medical information. DicomFlow is not certified, endorsed by, or affiliated with NEMA.")
                    .font(.callout)
            }
        }
        .formStyle(.grouped)
